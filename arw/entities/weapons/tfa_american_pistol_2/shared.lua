...
SWEP.PrintName				= "French Multi-Shot Cavalry Pistol"		-- Weapon name (Shown on HUD)	
...
SWEP.MuzzleFlashEffect = "effect_awoi_smoke_pistol" --Change to a string of your muzzle flash effect
SWEP.ViewModelFOV			= 50
SWEP.ViewModelFlip			= false
SWEP.ViewModel				= "models/weapons/awoi/v_french_1766_cavalry_pistol.mdl"	-- Weapon world model
SWEP.WorldModel				= "models/weapons/awoi/w_french_1766_cavalry_pistol.mdl"	-- Weapon view model
SWEP.UseHands				= false
...
SWEP.Primary.Sound			= Sound ("weapons/AWoI/pistol_1_fire.wav")		-- Script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector (-7.6, 0, 5.5)
SWEP.IronSightsAng = Vector (-6, -9, 0)
SWEP.SightsPos = Vector (-7.6, -3, 5.5)
SWEP.SightsAng = Vector (-7, -10.5, 0)
SWEP.RunSightsPos = Vector(3.444, -7.823, -6.27)
SWEP.RunSightsAng = Vector(20.695, 0, 0)
