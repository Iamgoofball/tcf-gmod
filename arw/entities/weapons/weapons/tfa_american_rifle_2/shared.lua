...
SWEP.PrintName				= "Charleville Multi-Shot Model 1728"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/awoi/v_model_1728.mdl"	-- Weapon world model
SWEP.WorldModel				= "models/weapons/awoi/w_model_1728.mdl"	-- Weapon view model
SWEP.UseHands				= false
