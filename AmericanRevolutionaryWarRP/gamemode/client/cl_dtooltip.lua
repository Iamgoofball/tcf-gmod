...
function PANEL:Paint( w, h )
	...
	draw.RoundedBox( 0, 0, 0, self:GetWide(), self:GetTall(), Color( 43, 44, 47, 255 ) )
	draw.OutlinedBox( 0, 0, self:GetWide(), self:GetTall(), 2, Color( 31, 35, 38, 255 ) )
