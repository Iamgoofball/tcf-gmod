...
SWEP.PrintName				= "English Multi-Shot Dragoon Pistol"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/awoi/v_english_dragoon_pistol.mdl"	-- Weapon world model
SWEP.WorldModel				= "models/weapons/awoi/w_english_dragoon_pistol.mdl"	-- Weapon view model
SWEP.UseHands				= false
...
SWEP.IronSightsAng = Vector (-6, -10, 0)
