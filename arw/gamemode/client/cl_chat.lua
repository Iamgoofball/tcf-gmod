...
function eChat.openSettings()
	...
	serverName:SetText( "ArwChat - Settings" )
	serverName:SetFont( "eChat_18")
	serverName:SizeToContents()
	serverName:SetPos( 5, 4 )
